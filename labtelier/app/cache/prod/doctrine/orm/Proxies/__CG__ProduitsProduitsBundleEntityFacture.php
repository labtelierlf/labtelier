 ...
 */
class Facture extends \Produits\ProduitsBundle\Entity\Facture implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setReglee($reglee);
    }

    public function getReglee()
    {
        $this->__load();
        return parent::getReglee();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'dateFacture', 'numeroFacture', 'reglee');
    }
