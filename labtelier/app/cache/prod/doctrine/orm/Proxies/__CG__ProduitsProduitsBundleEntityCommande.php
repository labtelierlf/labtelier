 ...
 */
class Commande extends \Produits\ProduitsBundle\Entity\Commande implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setHonoree($honoree);
    }

    public function getHonoree()
    {
        $this->__load();
        return parent::getHonoree();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'dateCommande', 'honoree', 'utilisateur', 'facture');
    }
