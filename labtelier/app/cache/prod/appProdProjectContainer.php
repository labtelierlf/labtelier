...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'gestionfacture' => 'getGestionfactureService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost:8889', 'port' => NULL, 'dbname' => 'labtelier', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_eee74ec7c4ede96cb4e89f4befc8f8f8');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_eee74ec7c4ede96cb4e89f4befc8f8f8');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_eee74ec7c4ede96cb4e89f4befc8f8f8');
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Utilisateurs/UtilisateursBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Produits/ProduitsBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Pages/PagesBundle/Entity')));
        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Utilisateurs\\UtilisateursBundle\\Entity');
        $f->addDriver($e, 'Produits\\ProduitsBundle\\Entity');
        ...
        $g->setEntityNamespaces(array('UtilisateursBundle' => 'Utilisateurs\\UtilisateursBundle\\Entity', 'ProduitsBundle' => 'Produits\\ProduitsBundle\\Entity', 'PagesBundle' => 'Pages\\PagesBundle\\Entity'));
    ...
    protected function getGestionfactureService()
    {
        return $this->services['gestionfacture'] = new \Produits\ProduitsBundle\Services\GestionFacture($this, $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['redirectionlistener'] = new \Produits\ProduitsBundle\Listener\RedirectionListener($this, $this->get('session'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('labtelier@gmail.com');
        $a->setPassword('eyFSwy2H');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Accueil/AccueilBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Produits/ProduitsBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Accueil/AccueilBundle/Resources/views'), 'Accueil');
        $instance->addPath(($this->targetDirs[3].'/src/Produits/ProduitsBundle/Resources/views'), 'Produits');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AccueilBundle' => 'Accueil\\AccueilBundle\\AccueilBundle',
                'ProduitsBundle' => 'Produits\\ProduitsBundle\\ProduitsBundle',
            ...
            'mailer_user' => 'labtelier@gmail.com',
            'mailer_password' => 'eyFSwy2H',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'labtelier@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'eyFSwy2H',
