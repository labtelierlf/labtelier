...
class PosteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('ProduitsBundle:Poste:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_postes_show', array('id' => $entity->getId())));
        }

        return $this->render('ProduitsBundle:Poste:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Poste $entity)
    {
        $form = $this->createForm(new PosteType(), $entity, array(
            'action' => $this->generateUrl('admin_postes_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProduitsBundle:Poste')->find($id);
        ...
        return $this->render('ProduitsBundle:Poste:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ProduitsBundle:Poste:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new PosteType(), $entity, array(
            'action' => $this->generateUrl('admin_postes_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_postes_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_postes'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_postes_delete', array('id' => $id)))
            ->setMethod('DELETE')
